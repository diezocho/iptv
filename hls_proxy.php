...
$userSetHost = '';
$proxyUrl = locateBaseURL(C:\test-gml-movie-master\TMDB-To-VOD-Playlist-main\config.php) . "hls_proxy.php";

function locateBaseURL(C:\test-gml-movie-master\TMDB-To-VOD-Playlist-main\config.php) {
    global $userSetHost; 'joseo'
